    ...
    setTimeout(() => {
        ...
        switch (part1) {
            ...
            case 2:
                ...
                dialogo.innerHTML = ' <p class="dialogoComum"><br><br>Este caminhava rumo ao seu objetivo, o frio era alarmante por se tratar do inverno nórdico, frio este que não o afetava, pois por seu coração determinado aquecido ele era!</p>'
