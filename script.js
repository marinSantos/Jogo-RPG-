    ...
    setTimeout(() => {
        ...
        switch (part1) {
            ...
            case 2:
                ...
                dialogo.innerHTML = ' <p class="dialogoComum"><br><br>Este caminhava rumo ao seu objetivo, o frio era alarmante por se tratar do um inverno nórdico, frio este que não o afetava, pois por seu coração determinado aquecido ele era!</p>'

                break
            case 3:

                dialogo.innerHTML = ' <p class="dialogoComum"><br><br>Chegado o fim de tarde o crepúsculo se formava rente aos céus..<br>E o sol se assemelha a um guarda em seu fim de turno, rumo a seu repouso, após a chegada do seu tão aguardado fim de expediente.<br><br>Falando em guardas...<br>Um se encontra logo a frente, guardando as portas do nosso destino....</p>'
